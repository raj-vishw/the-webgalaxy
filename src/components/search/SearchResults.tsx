  ...
  if (flat.length === 0) {
    return (
      <div className="px-3 py-8 text-center">
        <p className="font-sans text-[14px] text-white/85">Nothing found in the WebGalaxy.</p>
        <p className="mt-1 font-sans text-[12px] text-space-300/70">Try another search.</p>
