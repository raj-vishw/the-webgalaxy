...
export const websites: WebsiteDefinition[] = [
  ...
  { id: 'virustotal', name: 'VirusTotal', url: 'https://www.virustotal.com', universeId: 'cybersecurity', objectType: 'planet', importance: 80, description: 'Analyse suspicious files, URLs and hashes.', accent: '#394eff', glyph: 'VT', tags: ['malware', 'tools'] },
  { id: 'shodan', name: 'Shodan', url: 'https://www.shodan.io', universeId: 'cybersecurity', objectType: 'comet', importance: 70, description: 'Search engine for internet-connected devices.', accent: '#c93e3e', glyph: 'SH', tags: ['recon'] },
  ...
  { id: 'mitre-attack', name: 'MITRE ATT&CK', url: 'https://attack.mitre.org', universeId: 'cybersecurity', objectType: 'planet', importance: 76, description: 'Knowledge base of adversary tactics and techniques.', accent: '#d64f4f', glyph: 'ATT', tags: ['framework'] },
  ...
  { id: 'gitlab', name: 'GitLab', url: 'https://gitlab.com', universeId: 'development', objectType: 'planet', importance: 75, description: 'DevSecOps platform and git hosting.', accent: '#fc6d26', glyph: 'GL', tags: ['git', 'devops'] },
  ...
  { id: 'vercel', name: 'Vercel', url: 'https://vercel.com', universeId: 'development', objectType: 'planet', importance: 74, description: 'Frontend cloud and deployment platform.', accent: '#e6e6e6', glyph: '▲', tags: ['hosting'] },
  ...
  { id: 'replit', name: 'Replit', url: 'https://replit.com', universeId: 'development', objectType: 'comet', importance: 68, description: 'Collaborative browser-based IDE.', accent: '#f26207', glyph: 'Re', tags: ['ide'] },

  // ─── Design ──────────────────────────────────────────────────────────────
  { id: 'figma', name: 'Figma', url: 'https://www.figma.com', universeId: 'design', objectType: 'star', importance: 93, description: 'Collaborative interface design.', accent: '#a259ff', glyph: 'Fg', tags: ['ui', 'tools'] },
  ...
  { id: 'dribbble', name: 'Dribbble', url: 'https://dribbble.com', universeId: 'design', objectType: 'planet', importance: 70, description: 'Showcase for designers and creatives.', accent: '#ea4c89', glyph: 'Dr', tags: ['community'] },
  { id: 'behance', name: 'Behance', url: 'https://www.behance.net', universeId: 'design', objectType: 'planet', importance: 70, description: 'Creative portfolios by Adobe.', accent: '#1769ff', glyph: 'Be', tags: ['community'] },
  { id: 'framer', name: 'Framer', url: 'https://www.framer.com', universeId: 'design', objectType: 'comet', importance: 72, description: 'Design and publish interactive sites.', accent: '#66a3ff', glyph: 'Fr', tags: ['web', 'tools'] },
